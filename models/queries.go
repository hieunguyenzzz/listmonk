...
type Queries struct {
	...
	// Autoresponders
	GetAutorespondersForList *sqlx.Stmt `query:"get-autoresponders-for-list"`
	CheckAutoresponderSent   *sqlx.Stmt `query:"check-autoresponder-sent"`
	RecordAutoresponderSent  *sqlx.Stmt `query:"record-autoresponder-sent"`
}
